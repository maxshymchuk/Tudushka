  ...
  function(e, n, t) {
    ...
    var x = [
      ...
      L = (function() {
        function e() {
          ...
          var n = i.rand(0, x.length - 1);
          (this.backgroundColor = x[n][0]), (this.color = x[n][1]);
        }
        var n, t, o;
        return (
          (n = e),
    ...
    var C = (function() {
      ...
      S = function() {
        ...
        n.querySelector('.menu__create_note').addEventListener('click', function() {
          return new s();
        }),
          n.querySelector('.menu__create_folder').addEventListener('click', function() {
            return C.Prompt('Folder name:', T.AddFolder.bind(T));
          }),
          n.querySelector('.menu__open_completed').addEventListener('click', function() {
            return h.Show();
          }),
          l.Animate(e, { name: 'fading-moving-bottom', dir: c.Normal }, function() {
            e.style.opacity = 1;
          }),
