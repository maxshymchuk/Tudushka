      ...
      if (t) {
        ...
        for (; e; ) {
          ...
          this.options.pedantic
            ? ((h = 2), (o = s.trimStart()))
            : ((h = t[2].search(/[^ ]/)), (h = h > 4 ? 1 : h), (o = s.slice(h)), (h += t[1].length));
          let p = !1;
          if ((!s && /^ *$/.test(c) && ((l += c + '\n'), (e = e.substring(c.length + 1)), (n = !0)), !n)) {
            ...
            for (; e; ) {
              const a = e.split('\n', 1)[0];
              if (((c = a), this.options.pedantic && (c = c.replace(/^ {1,4}(?=( {4})*[^ ])/g, '  ')), r.test(c)))
                break;
              if (i.test(c)) break;
              if (t.test(c)) break;
              if (n.test(e)) break;
          ...
          let u,
            k = null;
          this.options.gfm &&
            ((k = /^\[[ xX]\] /.exec(o)), k && ((u = '[ ] ' !== k[0]), (o = o.replace(/^\[[ xX]\] +/, '')))),
        ...
        for (let e = 0; e < r.items.length; e++)
          if (
            ((this.lexer.state.top = !1), (r.items[e].tokens = this.lexer.blockTokens(r.items[e].text, [])), !r.loose)
          ) {
        ...
        if (
          !(
            ...
            this.options.extensions.block.some(
              s => !!(n = s.call({ lexer: this }, e, t)) && ((e = e.substring(n.raw.length)), t.push(n), !0)
            )
          )
        )
  ...
  class se {
    ...
    code(e, t, n) {
      ...
      return (
        (e = e.replace(/\n$/, '') + '\n'),
        s
          ? '<pre><code class="language-' + c(s) + '">' + (n ? e : c(e, !0)) + '</code></pre>\n'
        ...
        switch (r.type) {
          ...
          case 'table': {
            ...
            for (let t = 0; t < e.header.length; t++)
              s += this.renderer.tablecell(this.parseInline(e.header[t].tokens), { header: !0, align: e.align[t] });
            ...
            for (let t = 0; t < e.rows.length; t++) {
              ...
              for (let t = 0; t < n.length; t++)
                s += this.renderer.tablecell(this.parseInline(n[t].tokens), { header: !1, align: e.align[t] });
